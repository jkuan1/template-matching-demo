...
st.markdown("""
### Should I just remove every second row and every second column?
""")
...
st.markdown("""
### What if went further and removed every eighth row and column?
""")
...
page_gauss_worst = ndimage.gaussian_filter(page, sigma=worst / 2 )[::worst,::worst]
